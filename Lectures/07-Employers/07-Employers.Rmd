...
data.frame(
  v1 = c("Intercept", "", "NJ", "", "After", "", "NJ × After", ""),
...
- Consumers don't demand labor itself, but rather the goods that labor producers.
...
**Q:** What happens when the value of average product exceeds marginal revenue product? 
...
**Midterm** scheduled for Wednesday, April 28th during class time.

- I will discuss details this Wednesday.

**Problem Set 2** due Monday, April 26th by 4:00pm PDT.

- I will post it by tomorrow morning.
- Covers material from weeks 3 and 4.

The **syllabus** has changed!

- No reading this week; review session during class next Monday; lectures will resume week 6.
- The cost? One lecture on unions.

**I have jury duty this Wednesday:** No email from me .mono[=] business as usual.
