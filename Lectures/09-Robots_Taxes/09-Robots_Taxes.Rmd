...
$$\eta = \dfrac{\%\Delta E}{\%\Delta r} = \dfrac{(E_2 - E_1) / E_1}{(r_2 - r_1) / r_1} = \dfrac{(80-60)/60}{(5-1)/5} = \dfrac{1/3}{4/5} = \dfrac{5}{12} \approx 0.42$$
...
**Q:** How do we interpret the cross-elasticity of factor demand we just calculated? What does 0.42 tell us?

--

**A.sub[1]:** A 1-percent increase in the price of capital .mono[-->] 0.42-percent increase in labor demanded.
